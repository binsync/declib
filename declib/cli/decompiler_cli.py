...
def cmd_load(args) -> int:
    ...
    # Any unpacked IDA database here is crash residue -- but only if nothing is
    # actually using it. _clear_stale_ida_database establishes that from the
    # process table, not the registry, because the registry can lose a live
    # server and deleting a running server's database is not recoverable.
